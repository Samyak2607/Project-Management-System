...
<head>
    <meta charset="UTF-8">
    <title>{{Auth::user()->designation}}</title>
...
<body class="skin-blue">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="#" class="logo"><b>{{Auth::user()->designation}}</b></a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    <img src="{{ url('/') }}/dist/img/17420-doll-wallpaper.jpg" class="img-circle" alt="User Image" />
                                    <p>
                                        Surbhi Modi - Web Developer
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                      ...
                                      <a href="{{route('manager/profile',Auth::user()->id)}}" class="btn btn-default btn-flat">Profile</a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="active treeview">
                      @if(Auth::user()->designation == 'Admin')
                        ...
                        @elseif(Auth::user()->designation=='Manager')
                        <a href="{{route('manager-dashboard',Auth::user()->id)}}">
                            <i class="fa fa-dashboard"></i> <span>Dashboard</span> 
                        </a>

                        @else
                        <a href="{{route('employee.dashboard',Auth::user()->id)}}">
                    ...
                    <li>
                        @if(Auth::user()->designation=='Admin')
                        <a href="{{route('admin/register-manager-or-employee-intern-other')}}">
                            <i class="ion ion-person-add"></i> <span>Add User</span> <small class="label pull-right bg-green">new</small>
                        </a>
                        @endif
                    </li>
                    ...
                    <li>
                        ...
                        <a href="#">
                            <i class="fa fa-book"></i> <span>Contact Us</span> <small class="label pull-right bg-green">Cubedots</small>
                        </a>
                    ...
                    <li>
                        <a href="pages/mailbox/mailbox.html">
                            <i class="fa fa-envelope"></i> <span>Contact-box</span>
